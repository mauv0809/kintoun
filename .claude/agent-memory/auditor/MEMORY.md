...
- Rust orphan-file (src/*.rs not declared via mod): originally surfaced 2026-04-30, promoted to knowledge-base | last checked: 2026-04-30
- Phase-1/Phase-2 scaffold continuity across sessions: transcripts live in chat only — verify next session opens by pulling them from daily note or re-posting | last checked: 2026-04-30
