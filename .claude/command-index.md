...
| `/safe-clear` | Context pressure or task completion | Read, Write, Edit, Bash(date) | Self-execute | Distill state, flush context, auto-resume |
...
| 30+ tool calls in session | `/safe-clear` |
| Compaction warning | `/safe-clear` (emergency mode) |
| Discrete multi-step task completes | Consider `/safe-clear` |
| Quality feels degraded | `/safe-clear` |
